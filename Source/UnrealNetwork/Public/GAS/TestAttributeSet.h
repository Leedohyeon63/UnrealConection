...
#include "GAS/GameAvilitySystemMacro.h"
...
public:
	UPROPERTY(BlueprintReadOnly, Category = "Attribute|Heath", ReplicatedUsing = OnRep_Health)
	FGameplayAttributeData Health;
	ATTRIBUTE_ACCESSORS(UTestAttributeSet, Health);

	UPROPERTY(BlueprintReadOnly, Category = "Attribute|Heath", ReplicatedUsing = OnRep_MaxHealth)
