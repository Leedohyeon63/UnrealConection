...
#include "ParticeCharacter.generated.h"
...
UCLASS()
class UNREALNETWORK_API AParticeCharacter : public ACharacter
{
	GENERATED_BODY()
...
private:
	UPROPERTY()
	TWeakObjectPtr<class UDataLineUserWidget> HealthWidget = nullptr;
};
