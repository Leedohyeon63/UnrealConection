 ...
 */
UCLASS()
class UNREALNETWORK_API APracticeController : public APlayerController
{
	GENERATED_BODY()
public:
...
private:
	UPROPERTY()
	TWeakObjectPtr<class UHUDWidget> HUDWidget = nullptr;

	TWeakObjectPtr<class AParticeCharacter> ControlledCharacter = nullptr;
};
